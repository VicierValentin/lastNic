...
#define LV_VER_RES_MAX          (480) // pour definir la taille de l'�cran
...
#define LV_USE_BUILTIN_MALLOC 1
    ...
    #define LV_MEM_SIZE (256U * 2048U)          /*[bytes]*/
...
#define LV_FONT_CUSTOM_DECLARE	 LV_FONT_DECLARE(roboto_bold_54) LV_FONT_DECLARE(roboto_bold_180) LV_FONT_DECLARE(custom_montserrat_14) LV_FONT_DECLARE(custom_montserrat_18) LV_FONT_DECLARE(custom_montserrat_22) LV_FONT_DECLARE(custom_montserrat_32) LV_FONT_DECLARE(custom_montserrat_48)
...
#if LV_USE_FS_STDIO
    #define LV_FS_STDIO_LETTER 'I'     /*Set an upper cased letter on which the drive will accessible (e.g. 'A')*/
    #define LV_FS_STDIO_PATH "/data/img/"         /*Set the working directory. File/directory paths will be appended to it.*/
