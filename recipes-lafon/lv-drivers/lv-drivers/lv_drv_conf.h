...
#  if EVDEV_SCALE
#    define EVDEV_SCALE_HOR_RES     (4095)          /* Horizontal resolution of touchscreen */
#    define EVDEV_SCALE_VER_RES     (4095)          /* Vertical resolution of touchscreen */
#  endif  /*EVDEV_SCALE*/

/** PARAMETRE A CHANGER SI PB CALIBRATION POINTEUR **/
...
#    define EVDEV_HOR_MAX   16000
#    define EVDEV_VER_MIN   0
#    define EVDEV_VER_MAX   16000               //4095 (pour cran Ampire)
#  endif  /*EVDEV_SCALE*/
#endif  /*USE_EVDEV*/
